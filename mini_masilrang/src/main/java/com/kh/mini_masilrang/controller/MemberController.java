...
public class MemberController {
    ...
    public ResponseEntity<Boolean> profileUpdate(@RequestBody Map<String, String> profileImage) {
        String profileUrl = profileImage.get("url");
        String userNo = profileImage.get("userNum");
        MemberDAO dao = new MemberDAO();
        boolean isTrue =dao.profileUpdate(profileUrl,userNo);
        return new ResponseEntity<>(isTrue, HttpStatus.OK);
    }
